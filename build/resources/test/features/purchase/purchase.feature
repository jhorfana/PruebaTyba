Feature: shopping flow
  ...
  Background:
    ...
    Scenario Outline: Purchase of a product with different color references
      ...
      And the user selects 3 products of the current color
      And the user selects the Add to cart button
      And the user selects another color
      And the user selects 2 products of the indicated color
      And the user selects the Add to cart button
      ...
      And the user enters the card number <card number>
      ...
      Examples:
      |product                         | card number      | cvv | month | year | name      |
